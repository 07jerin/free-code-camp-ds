...
import com.jerin.freecodecamp.ds.UnionFind.UnionFindTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({ TreeSuite.class, OthersTestSuite.class, ListTestSuite.class, QueueSuite.class, UnionFindTest.class })
